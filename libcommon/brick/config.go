...
type Config interface {
	...
	// GetVal return interval value from config
	GetVal(name string, value ...interface{}) interface{}
...
// GetVal return interval value from config
func (p *JSONConfigService) GetVal(name string, value ...interface{}) interface{} {
	if r := p.props[name]; r != nil {
		return r
	} else {
		return value
